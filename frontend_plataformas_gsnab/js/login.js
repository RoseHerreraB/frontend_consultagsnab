...
loginForm.addEventListener("submit", function (event) {
    ...
    if (userType === "admin") {
        ...
        if (password === "admin123") {
            ...
            window.location.href = "http://localhost/frontend_plataformas_gsnab/subir_excel/index.html";  // Cambia esto a la página del administrador
        } else {
    ...
    if (userType === "estudiante") {
        ...
        window.location.href = "http://localhost/frontend_plataformas_gsnab/Consultar/index.html";  // Cambia esto a la página del estudiante
    } else {
